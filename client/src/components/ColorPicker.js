...
// const ColorPickerSizeColumnMemo = memo(ColorPickerSizeColumn);

// function ColorPicker({ productName, reviewCount, currentColor }) {
//   const [displayColor, setDisplayColor] = useState(currentColor);
//   const [sizes, setSizes] = useState([]);
//   const [ setCurrentColor] = useState(currentColor); // add this line
...
//       <div className="colorPicker-salePrice">Sale Price</div>
//       <div className="colorPicker-available">available</div>
//       <img className="colorPicker-colorButton" src={`../images/color-buttons/${currentColor}.jpg`} alt={`Selected color ${currentColor}`} />
//     </div>
//     {sizes.map((thisSize) => {
//       return (
//         <ColorPickerSizeColumnMemo
//           key={thisSize.id}
//           data={thisSize}
//         />
//       );
//     })}
//   </div>
//   <div className="colorPicker-addToCart blueBackground">
//     ADD TO CART
//   </div>
//   <select
//     name="userList"
//     id="userList"
//     className="colorPicker-listSelect"
//   >
//     <option value="Select">Select List</option>
//     <option value="Create">Create List & Add Item</option>
//   </select>
