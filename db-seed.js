    ...
    await new Promise((resolve, reject) =>
      pool.query(
        `INSERT INTO products (imageLink, productLink, style, productName, rating, numRatings, price) VALUES
          ('images/products/32_fs.webp', null, 'Softstyle® T-Shirt', 'Gildan 64000', 5.0, 626, 2.88),
          ('images/products/395_fs.webp', null, 'Heavy Blend™ Hooded Sweatshirt', 'Gildan 18500', 5.0, 609, 11.53),
          ('images/products/16_fs.webp', null, 'Heavy Cotton™ T-Shirt', 'Gildan 5000', 5.0, 503, 2.71),
          ('images/products/7584_fs.webp', null, 'CVC Jersey Tee', 'BELLA + CANAS 3001CVC', 5.0, 210, 5.48),
          ('images/products/29_fs.webp', null, 'Jersey Tee', 'BELLA + CANVAS 3001', 5.0, 272, 4.72),
          ('images/products/146_fs.webp', null, 'DryBlend® T-Shirt', 'Gildan 8000', 5.0, 197, 2.79),
          ('images/products/391_fs.webp', null, 'Ecosmart® Hooded Sweatshirt', 'Hanes P170', 5.0, 75, 8.26),
          ('images/products/393_fs.webp', null, 'NuBlend® Hooded Sweatshirt', 'JERZEES 996MR', 5.0, 163, 8.40),
          ('images/products/1828_fs.webp', null, 'Midweight Hooded Sweatshirt', 'Independent Trading CO. SS4500', 5.0, 125, 13.36),
          ('images/products/7500_fs.webp', null, 'Hammer™ Fleece Hooded Sweatshirt', 'Gildan HF500', 5.0, 1, 14.07),
          ('images/products/9126_fs.webp', null, 'Icon Lightweight Loopback Terry Hooded Sweatshirt', 'Independent Trading CO. SS1000', 5.0, 16, 15.86),
          ('images/products/9352_fs.webp', null, 'Softstyle® Hooded Sweatshirt', 'Gildan SF500', null, null, 13.91),
          ('images/products/372_fs.webp', null, 'Heavy Blend™ Crewneck Sweatshirt', 'Gildan 18000', 5.0, 600, 6.52),
          ('images/products/415_fs.webp', null, 'Heavy Blend™ Full-Zip Hooded Sweatshirt', 'Gildan 18600', 5.0, 218, 17.26),
          ('images/products/428_fs.webp', null, 'Heavy Blend™ Sweatpants', 'Gildan 18200', 5.0, 54, 11.14),
          ('images/products/557_fs.webp', null, 'Heavy Blend™ Youth Hooded Sweatshirt', 'Gildan 18500B', 5.0, 41, 12.82),
          ('images/products/571_fs.webp', null, 'Heavy Blend™ Youth Sweatshirt', 'Gildan 18000B', 5.0, 10, 7.26),
          ('images/products/576_fs.webp', null, 'Heavy Blend™ Youth Sweatpants', 'Gildan 18200B', 5.0, 2, 12.76)
        `,
        (err, data) => {
          if (err) {
